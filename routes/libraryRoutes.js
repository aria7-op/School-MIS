...
const libraryCoverStorageLimit = enforceStorageLimit({
    byteCounter: (req) => Number(req.file?.size || 0),
    message: 'Library media upload exceeds your subscription storage allowance. Please upgrade or remove existing files.',
});

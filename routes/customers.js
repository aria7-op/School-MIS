...
import { enforceStorageLimit, requirePackageFeature } from '../middleware/packageLimits.js';
import { 
  getAllCustomers, 
  getCustomerById, 
  createCustomer, 
...
const customerDocumentStorageLimit = enforceStorageLimit({
  ...
  message:
    'Document upload exceeds the storage allocation for your subscription. Please upgrade your plan or remove existing files.',
});

...
import { rateLimiter, createCustomLimiter } from '../middleware/rateLimit.js';
...
// Apply stricter rate limiting to message routes
const messageRateLimiter = createCustomLimiter({
...
router.use(
  requirePackageFeature('messaging', {
    userMessage: 'Messaging is currently unavailable. Please contact your administrator.',
  }),
);

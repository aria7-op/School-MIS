...
import {rateLimit, fileUploadLimiter} from '../middleware/rateLimit.js';
import {upload, processUploadedFile} from '../middleware/upload.js';
import { enforceStorageLimit } from '../middleware/packageLimits.js';
import {createAuditLog} from '../middleware/audit.js';

const transportController = new TransportController();

const transportImageStorageLimit = enforceStorageLimit({
    byteCounter: (req) => Number(req.file?.size || 0),
    message: 'Transport media upload exceeds your subscription storage allowance. Please upgrade or remove existing files.',
});

...
const equipmentFileStorageLimit = enforceStorageLimit({
    byteCounter: (req) => Number(req.file?.size || 0),
    message: 'Equipment file upload exceeds your subscription storage allowance. Please upgrade or remove existing files.',
});

...
// Simple encrypt/decrypt functions using CryptoJS for compatibility
export const encrypt = (text, key = process.env.API_ENCRYPTION_KEY) => {
    if (!key) {
...
export const decrypt = (encryptedText, key = process.env.API_ENCRYPTION_KEY) => {
    if (!key) {

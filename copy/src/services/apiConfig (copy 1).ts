...
export const API_CONFIG = {
  // Base URLs
  BASE_URL: process.env.REACT_APP_API_BASE_URL || 'https://khwanzay.school/api',
  WS_BASE_URL: process.env.REACT_APP_WS_BASE_URL || 'wss://khwanzay.school:4000',
  
  // Encryption Settings
  ENCRYPTION_KEY: process.env.REACT_APP_API_ENCRYPTION_KEY || 'your-secure-encryption-key-here',

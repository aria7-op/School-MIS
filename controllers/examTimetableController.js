...
class ExamTimetableController {
  ...
  async createExamTimetable(req, res) {
    try {
      ...
      handleError(res, error, 'create exam timetable');
    }
  }
  ...
  async getExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetables');
    }
  }
  ...
  async getExamTimetableById(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetable');
    }
  }
  ...
  async updateExamTimetable(req, res) {
    try {
      ...
      handleError(res, error, 'update exam timetable');
    }
  }
  ...
  async deleteExamTimetable(req, res) {
    try {
      ...
      handleError(res, error, 'delete exam timetable');
    }
  }
  ...
  async restoreExamTimetable(req, res) {
    try {
      ...
      handleError(res, error, 'restore exam timetable');
    }
  }
  ...
  async checkConflicts(req, res) {
    try {
      ...
      handleError(res, error, 'check conflicts');
    }
  }
  ...
  async generateOptimalSchedule(req, res) {
    try {
      ...
      handleError(res, error, 'generate optimal schedule');
    }
  }
  ...
  async getExamTimetableStats(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetable statistics');
    }
  }
  ...
  async getExamTimetableAnalytics(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetable analytics');
    }
  }
  ...
  async getExamTimetablePerformance(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetable performance');
    }
  }
  ...
  async bulkCreateExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'bulk create exam timetables');
    }
  }
  ...
  async bulkUpdateExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'bulk update exam timetables');
    }
  }
  ...
  async bulkDeleteExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'bulk delete exam timetables');
    }
  }
  ...
  async searchExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'search exam timetables');
    }
  }
  ...
  async getExamTimetablesByExam(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetables by exam');
    }
  }
  ...
  async getExamTimetablesBySubject(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetables by subject');
    }
  }
  ...
  async getUpcomingExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'get upcoming exam timetables');
    }
  }
  ...
  async generateExamTimetableReport(req, res) {
    try {
      ...
      handleError(res, error, 'generate exam timetable report');
    }
  }
  ...
  async getExamTimetableDistribution(req, res) {
    try {
      ...
      handleError(res, error, 'get exam timetable distribution');
    }
  }
  ...
  async exportExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'export exam timetables');
    }
  }
  ...
  async importExamTimetables(req, res) {
    try {
      ...
      handleError(res, error, 'import exam timetables');
    }
  }
  ...
  async getCacheStats(req, res) {
    try {
      ...
      handleError(res, error, 'get cache statistics');
    }
  }

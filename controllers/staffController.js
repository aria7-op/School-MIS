...
class StaffController {
  ...
  async createStaff(req, res) {
    try {
      ...
      const result = await staffService.createStaff(staffData, userId, scope);
  ...
  async getStaffByDepartment(req, res) {
    try {
      ...
      const result = await staffService.getStaffByDepartment(parseInt(departmentId), scope);
  ...
  async getStaff(req, res) {
    ...
    try {
      ...
      const result = await staffService.getStaff(filters, scope, include);
  ...
  async getStaffById(req, res) {
    try {
      ...
      const result = await staffService.getStaffById(parseInt(id), scope, include);
  ...
  async updateStaff(req, res) {
    try {
      ...
      const result = await staffService.updateStaff(parseInt(id), updateData, userId, scope);
  ...
  async deleteStaff(req, res) {
    try {
      ...
      const result = await staffService.deleteStaff(parseInt(id), userId, scope);
  ...
  async restoreStaff(req, res) {
    try {
      ...
      const result = await staffService.restoreStaff(parseInt(id), userId, scope);
  ...
  async getStaffStats(req, res) {
    try {
      ...
      const result = await staffService.getStaffStats(parseInt(id), scope);
  ...
  async getStaffAnalytics(req, res) {
    try {
      ...
      const result = await staffService.getStaffAnalytics(parseInt(id), scope, period);
  ...
  async getStaffPerformance(req, res) {
    try {
      ...
      const result = await staffService.getStaffPerformance(parseInt(id), scope);
  ...
  async bulkCreateStaff(req, res) {
    try {
      ...
      const result = await staffService.bulkCreateStaff(bulkData, userId, scope);
  ...
  async bulkUpdateStaff(req, res) {
    try {
      ...
      const result = await staffService.bulkUpdateStaff(bulkData, userId, scope);
  ...
  async bulkDeleteStaff(req, res) {
    try {
      ...
      const result = await staffService.bulkDeleteStaff(bulkData, userId, scope);
  ...
  async searchStaff(req, res) {
    try {
      ...
      const result = await staffService.searchStaff(query.trim(), scope, include);
  ...
  async exportStaff(req, res) {
    try {
      ...
      const result = await staffService.exportStaff(filters, scope, format);
  ...
  async importStaff(req, res) {
    try {
      ...
      const result = await staffService.importStaff(importData, userId, scope);
  ...
  async generateEmployeeIdSuggestions(req, res) {
    try {
      ...
      const result = await staffService.generateEmployeeIdSuggestions(designation.trim(), scope);
  ...
  async getStaffCountByDepartment(req, res) {
    try {
      ...
      const result = await staffService.getStaffCountByDepartment(scope);
  ...
  async getStaffCountByDesignation(req, res) {
    try {
      ...
      const result = await staffService.getStaffCountByDesignation(scope);
  ...
  async getStaffBySchool(req, res) {
    try {
      ...
      const result = await staffService.getStaffBySchool(scope, include);
  ...
  async warmCache(req, res) {
    try {
      ...
      const result = await staffService.warmCache(scope, staffId);
  ...
  async clearCache(req, res) {
    try {
      ...
      const result = await staffService.clearCache(all ? null : scope);

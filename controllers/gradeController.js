...
class GradeController {
  ...
  async createGrade(req, res) {
    try {
      ...
      handleError(res, error, 'create grade');
    }
  }
  ...
  async getGrades(req, res) {
    try {
      ...
      handleError(res, error, 'get grades');
    }
  }
  ...
  async getGradeById(req, res) {
    try {
      ...
      handleError(res, error, 'get grade');
    }
  }
  ...
  async updateGrade(req, res) {
    try {
      ...
      handleError(res, error, 'update grade');
    }
  }
  ...
  async deleteGrade(req, res) {
    try {
      ...
      handleError(res, error, 'delete grade');
    }
  }
  ...
  async restoreGrade(req, res) {
    try {
      ...
      handleError(res, error, 'restore grade');
    }
  }
  ...
  async getGradeStats(req, res) {
    try {
      ...
      handleError(res, error, 'get grade statistics');
    }
  }
  ...
  async getGradeAnalytics(req, res) {
    try {
      ...
      handleError(res, error, 'get grade analytics');
    }
  }
  ...
  async getGradePerformance(req, res) {
    try {
      ...
      handleError(res, error, 'get grade performance');
    }
  }
  ...
  async bulkCreateGrades(req, res) {
    try {
      ...
      handleError(res, error, 'bulk create grades');
    }
  }
  ...
  async bulkUpdateGrades(req, res) {
    try {
      ...
      handleError(res, error, 'bulk update grades');
    }
  }
  ...
  async bulkDeleteGrades(req, res) {
    try {
      ...
      handleError(res, error, 'bulk delete grades');
    }
  }
  ...
  async searchGrades(req, res) {
    try {
      ...
      handleError(res, error, 'search grades');
    }
  }
  ...
  async getGradesByStudent(req, res) {
    try {
      ...
      handleError(res, error, 'get grades by student');
    }
  }
  ...
  async getGradesByExam(req, res) {
    try {
      ...
      handleError(res, error, 'get grades by exam');
    }
  }
  ...
  async getGradesBySubject(req, res) {
    try {
      ...
      handleError(res, error, 'get grades by subject');
    }
  }
  ...
  async calculateStudentGPA(req, res) {
    try {
      ...
      handleError(res, error, 'calculate student GPA');
    }
  }
  ...
  async calculateStudentCGPA(req, res) {
    try {
      ...
      handleError(res, error, 'calculate student CGPA');
    }
  }
  ...
  async generateGradeReport(req, res) {
    try {
      ...
      handleError(res, error, 'generate grade report');
    }
  }
  ...
  async getGradeDistribution(req, res) {
    try {
      ...
      handleError(res, error, 'get grade distribution');
    }
  }
  ...
  async exportGrades(req, res) {
    try {
      ...
      handleError(res, error, 'export grades');
    }
  }
  ...
  async importGrades(req, res) {
    try {
      ...
      handleError(res, error, 'import grades');
    }
  }

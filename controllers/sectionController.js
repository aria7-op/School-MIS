...
class SectionController {
  ...
  async createSection(req, res) {
    try {
      ...
      handleError(res, error, 'create section');
    }
  }
  ...
  async getSections(req, res) {
    try {
      ...
      handleError(res, error, 'get sections');
    }
  }
  ...
  async getSectionById(req, res) {
    try {
      ...
      handleError(res, error, 'get section');
    }
  }
  ...
  async updateSection(req, res) {
    try {
      ...
      handleError(res, error, 'update section');
    }
  }
  ...
  async deleteSection(req, res) {
    try {
      ...
      handleError(res, error, 'delete section');
    }
  }
  ...
  async restoreSection(req, res) {
    try {
      ...
      handleError(res, error, 'restore section');
    }
  }
  ...
  async getSectionStats(req, res) {
    try {
      ...
      handleError(res, error, 'get section statistics');
    }
  }
  ...
  async getSectionAnalytics(req, res) {
    try {
      ...
      handleError(res, error, 'get section analytics');
    }
  }
  ...
  async getSectionPerformance(req, res) {
    try {
      ...
      handleError(res, error, 'get section performance');
    }
  }
  ...
  async bulkCreateSections(req, res) {
    try {
      ...
      handleError(res, error, 'bulk create sections');
    }
  }
  ...
  async bulkUpdateSections(req, res) {
    try {
      ...
      handleError(res, error, 'bulk update sections');
    }
  }
  ...
  async bulkDeleteSections(req, res) {
    try {
      ...
      handleError(res, error, 'bulk delete sections');
    }
  }
  ...
  async searchSections(req, res) {
    try {
      ...
      handleError(res, error, 'search sections');
    }
  }
  ...
  async getSectionsByClass(req, res) {
    try {
      ...
      handleError(res, error, 'get sections by class');
    }
  }
  ...
  async getSectionsByTeacher(req, res) {
    try {
      ...
      handleError(res, error, 'get sections by teacher');
    }
  }
  ...
  async generateSectionReport(req, res) {
    try {
      ...
      handleError(res, error, 'generate section report');
    }
  }
  ...
  async generateNameSuggestions(req, res) {
    try {
      ...
      handleError(res, error, 'generate name suggestions');
    }
  }
  ...
  async exportSections(req, res) {
    try {
      ...
      handleError(res, error, 'export sections');
    }
  }
  ...
  async importSections(req, res) {
    try {
      ...
      handleError(res, error, 'import sections');
    }
  }
